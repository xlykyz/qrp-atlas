...
INDEX_BASIC = TableSchema(
    ...
    columns=(
        ...
        ColumnSpec(BASE_DATE, "DATE", nullable=False),
        ColumnSpec(BASE_POINT, "DOUBLE", nullable=False),
        ColumnSpec(LIST_DATE, "DATE", nullable=False),
...
ALL_TABLES = (DAILY_MARKET_SNAPSHOT, MARKET_PHASE, TRADE_EXECUTION, STOCK_INFO, TRADING_CALENDAR, ADJ_FACTOR_CHANGES, CNINFO_RESEARCH_VISITS, RESEARCH_REPORT_STOCK, RESEARCH_REPORT_INDUSTRY, INDEX_BASIC, INDEX_DAILY, ZT_POOL, DT_POOL, DAILY_BASIC, SUSPEND_D, SYSTEM_B_STATE_OBSERVATION, SYSTEM_B_PRODUCTION_RUN, SYSTEM_B_EPISODE, SYSTEM_B_EPISODE_OBSERVATION, SYSTEM_B_POOL_MEMBERSHIP, SYSTEM_B_POOL_RUN, IRM_INTERACTION_QA, INCOME_STATEMENT, BALANCE_SHEET, CASHFLOW_STATEMENT, FINANCIAL_INDICATOR, INDUSTRY_MEMBERSHIP_HISTORY, INDEX_COMPONENT_HISTORY, EARNINGS_FORECAST_EVENT)
