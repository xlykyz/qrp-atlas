...
PRICE_FIELDS = (OPEN, HIGH, LOW, CLOSE, PRE_CLOSE, ENTRY_PRICE, EXIT_PRICE, HALF_SELL_PRICE, CURRENT_PRICE)

NUMERIC_FIELDS = (
    OPEN, HIGH, LOW, CLOSE, VOLUME, AMOUNT,
    PCT_CHANGE, CHANGE, TURNOVER, MARKET_CAP, FLOAT_CAP, PRE_CLOSE,
    ENTRY_PRICE, EXIT_PRICE, HALF_SELL_PRICE,
    HALF_SELL_TRIGGER, POSITION_PCT, CURRENT_PRICE
)

BOOLEAN_FIELDS = (IS_ST, IS_LIMIT_UP, IS_LIMIT_DOWN, M1_CORE, M2_FRONT, M3_IDENTIFIABLE, V_TRIGGERED, V_TRIGGERED_LOWER)
...
# ── M4 & Theme Index 字段 ──
THEME_DAILY_RETURN = "theme_daily_return"
THEME_LIMIT_UP_COUNT = "theme_limit_up_count"
THEME_RETURN_RANK = "theme_return_rank"
EFFECTIVE_MEMBER_COUNT = "effective_member_count"
TOTAL_MEMBER_COUNT = "total_member_count"
COMPARISON_UNIVERSE_SIZE = "comparison_universe_size"
COMPARISON_UNIVERSE_VERSION = "comparison_universe_version"
QUALIFICATION_STATUS = "qualification_status"
INDEX_LEVEL = "index_level"
BASE_LEVEL = "base_level"
IS_THEME_MEMBER = "is_theme_member"
IS_M4_EFFECTIVE_MEMBER = "is_m4_effective_member"
EXCLUSION_REASON = "exclusion_reason"
CUSTOM_INDEX_TREND_STATE = "custom_index_trend_state"
CUSTOM_INDEX_TREND_RUN_DAYS = "custom_index_trend_run_days"
CUSTOM_INDEX_EPISODE_ID = "custom_index_episode_id"
IS_SUSPENDED = "is_suspended"
THEME_PRODUCTION_RUN_TABLE = "theme_production_run"
KNOWLEDGE_DATE = "knowledge_date"
RULE_VERSION = "rule_version"
FINALIZED_AT = "finalized_at"

# ── 人气榜 / 热股榜字段（dc_hot / ths_hot） ──
LIST_NAME = "list_name"
RANK_POSITION = "rank_position"
SOURCE_RANK_TIME = "source_rank_time"
