...
> **实测进展（2026-09-10）**：本节 8 项已在内网生产机上完成**只读实测**，逐项结论见 [生产环境实测调研报告](./生产环境实测调研报告.md)。其中前 7 项已查清（含 C-02 确证、C-03/C-05 口径修正），第 8 项 **root 级 crontab 因权限受限仍未验证**，按 §9.5 约定继续保留在本节，不标为已关闭。
