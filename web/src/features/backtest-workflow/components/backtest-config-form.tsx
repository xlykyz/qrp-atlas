...
import { ENTRY_TIMING_OPTIONS, UNIVERSE_PRESETS } from '../lib/form-model';
...
export function BacktestConfigForm({ form, errors = {}, disabled, onChange }: Props) {
  const isCustomUniverse = form.universePreset === 'CUSTOM' || form.universeMode === 'tickers';
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div>
          ...
          <Select
            ...
            onValueChange={(v) => v && onChange({ entryTiming: v as BacktestWorkflowFormState['entryTiming'] })}
            disabled={disabled}
          >
            <SelectTrigger className="w-full">
